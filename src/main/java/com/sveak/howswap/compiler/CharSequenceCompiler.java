...
public class CharSequenceCompiler<T> {
    ...
    // The com.sveak.howswap.compiler instance that this facade uses.
    private final JavaCompiler compiler;

    // The com.sveak.howswap.compiler options (such as "-target" "1.5").
    private final List<String> options;

    // collect com.sveak.howswap.compiler diagnostics in this instance.
     ...
     *
     * @param loader  the application ClassLoader. The com.sveak.howswap.compiler will look through to
     *                this // class loader for dependent classes
     * @param options The com.sveak.howswap.compiler options (such as "-target" "1.5"). See the usage
     *                for javac
     * @throws IllegalStateException if the Java com.sveak.howswap.compiler cannot be loaded.
     */
    public CharSequenceCompiler(ProxyClassLoader loader, Iterable<String> options) {
        compiler = ToolProvider.getSystemJavaCompiler();
        if (compiler == null) {
            throw new IllegalStateException("Cannot find the system Java com.sveak.howswap.compiler. "
    ...
    public synchronized Map<String, Class<T>> compile(
        ...
        // Get a CompliationTask from the com.sveak.howswap.compiler and compile the sources
    ...
    /**
     * @return This com.sveak.howswap.compiler's class loader.
     */
...
/**
 * A JavaFileObject which contains either the source text or the com.sveak.howswap.compiler
 * generated class. This class is used in two cases.
 * <ol>
 * <li>This instance uses it to store the source which is passed to the
 * com.sveak.howswap.compiler. This uses the
 * {@link JavaFileObjectImpl#JavaFileObjectImpl(String, CharSequence)}
 * constructor.
 * <li>The Java com.sveak.howswap.compiler also creates instances (indirectly through the
...
final class JavaFileObjectImpl extends SimpleJavaFileObject {
    ...
    /**
     * @return the byte code generated by the com.sveak.howswap.compiler
     */
    byte[] getByteCode() {
