...
public final class SourcesAndDependencies {
    ...
    /**
     * Decides what to compile using com.sveak.howswap.CompilationScope (hierarchical search)
    ...
    private void collectDependent(String dependencyClassName, Map<String, CharSequence> dependentSources) throws IOException {
        ...
        if (removedClass != null) {
            for (String dependentName : removedClass.getDependent()) {
